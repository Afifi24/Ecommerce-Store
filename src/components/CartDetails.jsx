  ...
  return (
    <div className='w-[90%] mt-20 rounded-xl overflow-hidden h-[90vh] max-h-screen shaddow my-4 m-auto flex items-start flex-col md:flex-row gap-4 '>
        ...
        <div className='flex-1 p-4 flex flex-col gap-4 '>
            ...
            <button className='uppercase px-4 rounded-full w-full sm:w-fit py-3 bg-black text-white hover:text-black hover:bg-transparent border border-transparent hover:border-black duration-200 font-bold mt-10 '>Add to cart</button>
        </div>
    </div>
  )
}
